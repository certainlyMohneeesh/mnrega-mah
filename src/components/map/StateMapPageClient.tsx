      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="text-sm font-semibold text-blue-900 mb-1">Can't find your district on the map?</h4>
              <p className="text-sm text-blue-800">
                If your district is not visible on the map above, please check the <strong>All Districts</strong> list below. 
                You can click on any district name to view its detailed dashboard.
              </p>
            </div>
          </div>
        </div>
