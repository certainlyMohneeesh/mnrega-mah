...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'district.expenditureCr': 'Expenditure (Cr)',
    ...
    'compare.expenditureComparisonDesc': 'Monthly expenditure over the last 12 months (in Crores)',
  ...
  mr: {
    ...
    'district.expenditureCr': 'खर्च (कोटी)',
    ...
    'compare.expenditureComparisonDesc': 'गेल्या १२ महिन्यांमधील मासिक खर्च (कोटींमध्ये)',
  ...
  hi: {
    ...
    'district.expenditureCr': 'व्यय (करोड़)',
    ...
    'compare.expenditureComparisonDesc': 'पिछले 12 महीनों में मासिक व्यय (करोड़ों में)',
